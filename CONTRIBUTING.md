...
# Contribute to Ory summit-platform<!-- omit in toc -->
...
_Please note_: We take Ory summit-platform's security and our users' trust very
seriously. If you believe you have found a security issue in Ory
summit-platform, please disclose it by contacting us at security@ory.sh.
...
won't clash with Ory summit-platform's direction. A great way to do this is via
[Ory summit-platform Discussions](https://github.com/orgs/ory/discussions) or
the [Ory Chat](https://www.ory.sh/chat).

## FAQ

- I am new to the community. Where can I find the
  [Ory Community Code of Conduct?](https://github.com/ory/summit-platform/blob/master/CODE_OF_CONDUCT.md)

- I have a question. Where can I get
  [answers to questions regarding Ory summit-platform?](#communication)
...
- I want to talk to other Ory summit-platform users.
  [How can I become a part of the community?](#communication)

- I would like to know what I am agreeing to when I contribute to Ory
  summit-platform. Does Ory have
  [a Contributors License Agreement?](https://cla-assistant.io/ory/summit-platform)

- I would like updates about new versions of Ory summit-platform.
...
[list of good first issues](https://github.com/ory/summit-platform/labels/good%20first%20issue).
...
- **Give us a star.** It may not seem like much, but it really makes a
  ...
  summit-platform. Github stars help the project gain visibility and stand out.
...
- **Help with open issues.** We have a lot of open issues for Ory
  summit-platform and some of them may lack necessary information, some are
...
Check out
[Ory summit-platform Discussions](https://github.com/orgs/ory/discussions). This
...
summit-platform, consider joining the mailing list. We will _only_ send you
...
summit-platform's roadmap and architecture.
...
1. Add a descriptive prefix to commits. This ensures a uniform commit history
   ...
   [Convential Commits configuration](https://github.com/ory/summit-platform/blob/master/.github/workflows/conventional_commits.yml)
...
[Contributor License Agreement](https://cla-assistant.io/ory/summit-platform).
...
git clone git@github.com:ory/ory/summit-platform.git

# Next you add a git remote that is your fork:
git remote add fork git@github.com:<YOUR-GITHUB-USERNAME-HERE>/ory/summit-platform.git
