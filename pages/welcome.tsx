    ...
    <Page meta={meta}>
      ...
      <Textbox>
          <div className="textbox">
            ...
            <ul>
              <li>
                <strong>Ory implementation -</strong> tell us about how you implemented Ory software
              ...
              <li>
                <strong>Community Talks -</strong> tell us about your experiences being part of the
                Ory Community
              </li>
              <li>
            ...
            <h3>Format</h3>
            <ul>
              <li>Presentation: 30 minutes (including Q&A)</li>
              <li>Workshop: up to 2 hours</li>
            </ul>
            <h3>Deadline</h3>
            <ul>
              <li>Submit abstract: Friday, 27 May 2022.</li>
              <li>Submit final paper: Friday, 19 August 2022.</li>
            </ul>
            <p>
            ...
            <h2>Formats</h2>
            <p>The Ory Summit 2022 offers two different formats:</p>
            <ul>
              <li>
                <p>Presentation Duration: 30 Minutes </p>
                <p>
                  This can be a talk about a specific topic, a demonstration of a use case or
                  implementation or a business focused talk. Generally in the format of speaker &
                  slideshow, but let your imagination run wild.
                </p>
              </li>
              <li>
                <p>Workshop Duration: up to 2 Hours</p>
                <p>
                  {' '}
                  A practical demonstration usually involving live coding and code examples that the
                  audience can download and use to take part in the workshop.
                </p>
              </li>
            </ul>
            <p>
